...
public class TestQueue {
	...
	public void enqueuedequeue() throws QueueEmptyException {
		...
		s.enqueue(2);
		s.enqueue(3);
		assertEquals("Eins", 1, s.dequeue());
		s.enqueue(4);
		assertEquals("Zwei", 2, s.dequeue());
		s.enqueue(5);
		s.enqueue(6);
		assertEquals("Drei", 3, s.dequeue());
		assertEquals("Vier", 4, s.dequeue());
		assertEquals("F�nf", 5, s.dequeue());
		assertEquals("Sechs", 6, s.dequeue());
		s.enqueue(7);
		assertEquals("Sieben", 7, s.dequeue());
		s.enqueue(8);
		s.enqueue(9);
		assertEquals("Acht", 8, s.dequeue());
		assertEquals("Neun", 9, s.dequeue());
	}
